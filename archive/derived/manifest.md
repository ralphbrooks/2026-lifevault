# Manifest — Ralph LifeVault Working Memory
...
This Google Drive folder is the published working-memory copy.

Raw logs preserve real-world activity. Derived files are summaries for faster orientation.
